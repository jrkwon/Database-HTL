...
/*
 *  –eÀi äÅ¨˜ Ãa∑©∑Å äÅπ°  1.03
 *  -------------------------------------------------------------------
 *  Ø¢•i∏a - HANyang gulTLE ConFiGuration File V 1.03<EOF><NULL>
 *                     42§a∑°Àa
 *  êÅ∏˜ —¬∏w∏a        5§a∑°Àa
 *  »ì êÏ∑°            4ß°Àa
 *  óiµa≥aã°           1ß°Àa
...
void initusermenu(int fcolor, int bcolor, int init_menu)
{
  ...
  pmenu[0].item[6] = "îh”• äa¢Ö∑i..";pmenu[0].shortcut[6] = 0;
  ...
  pmenu[2].item[2] = "ßiú‚ ŒaØ°";    pmenu[2].shortcut[2] = CTRL_O;
...
/*
 *  µw—¡ 'îh”• äa¢Ö∑i µi°a'üi •°°e.
 *  ãa â≥Øi†·ü° µw¥·¨Â¨óì±∑° 'L'ù° Ø°∏b–aìe àa∏w ¥aüqîa∂Ö †i
 *  ≠Aàaª°üi ¢â¥·•°ìe ∏w°e∑° ∑∂ª°∂a.
 *
 *  Love(¨aúw), Liberty(∏a∑A), Labor(ë°ï∑)
 *
 */
void cine_view(void)
{
  if(wopen(10, 4, 60, 19)) {
    wtitle("Ÿ∫       îh”• äa¢Ö∑i µi°a       ‘ë");
